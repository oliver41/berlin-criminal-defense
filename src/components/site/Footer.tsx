      ...
      <div className="container-editorial py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-6 text-sm text-muted-foreground max-w-sm leading-relaxed">
            {locale === "de"
              ? "Diskrete und entschiedene Strafverteidigung sowie engagierte Opfervertretung in ganz Berlin und bundesweit."
              : "Discreet, decisive criminal defense and committed victim representation throughout Berlin and across Germany."}
          </p>
        </div>
      ...
      <div className="border-t border-border">
        <div className="container-editorial py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-xs text-muted-foreground">
          ...
          <div className="flex gap-6">
            <span className="hover:text-accent cursor-pointer">{t.footer.imprint}</span>
            <span className="hover:text-accent cursor-pointer">{t.footer.privacy}</span>
          </div>
        </div>
      </div>
    </footer>
